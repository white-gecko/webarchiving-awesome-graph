...
groups:
- [Awesome Website Change Monitoring](http://awesome.org/iipc/Awesome_Website_Change_Monitoring)  💽 ⭐ 513 👀 25
...
- [Archives Unleashed Toolkit](http://awesome.org/iipc/Archives_Unleashed_Toolkit) - Archives Unleashed Toolkit (AUT) is an open-source platform for analyzing web archives with Apache Spark.  💽 ⭐ 155 👀 13
...
- [Common Crawl Jupyter notebooks](http://awesome.org/iipc/Common_Crawl_Jupyter_notebooks) - A collection of notebooks using Common Crawl's various datasets.  💽 ⭐ 64 👀 16
...
- [FlameShot](http://awesome.org/iipc/FlameShot) - Screen capture and annotation on Ubuntu. 💽 ⭐ 29609 👀 211
...
- [xDoTool](http://awesome.org/iipc/xDoTool) - Click automation on Ubuntu. 💽 ⭐ 3752 👀 62
...
- [FastWARC](http://awesome.org/iipc/FastWARC) - A high-performance WARC parsing library (Python). 💽 ⭐ 135 👀 9
...
- [jwarc](http://awesome.org/iipc/jwarc) - Read and write WARC files with a type safe API (Java). 💽 ⭐ 55 👀 4
...
- [Auto Archiver](http://awesome.org/iipc/Auto_Archiver) - Python script to automatically archive social media posts, videos, and images from a Google Sheets document. Read the  💽 ⭐ 1059 👀 22
- [Browsertrix Crawler](http://awesome.org/iipc/Browsertrix_Crawler) - A Chromium based high-fidelity crawling system, designed to run a complex, customizable browser-based crawl in a single Docker container.  💽 ⭐ 1009 👀 23
- [Brozzler](http://awesome.org/iipc/Brozzler) - A distributed web crawler (爬虫) that uses a real browser (Chrome or Chromium) to fetch pages and embedded urls and to extract links.  💽 ⭐ 794 👀 36
...
- [SingleFile](http://awesome.org/iipc/SingleFile) - Browser extension for Firefox/Chrome and CLI tool to save a faithful copy of a complete page as a single HTML file.  💽 ⭐ 20792 👀 138
...
- [Waybackpy](http://awesome.org/iipc/Waybackpy) -  Wayback Machine Save, CDX and availability API interface in Python and a command-line tool   💽 ⭐ 567 👀 8
...
- [Wpull](http://awesome.org/iipc/Wpull) - A Wget-compatible (or remake/clone/replacement/alternative) web downloader and crawler.  💽 ⭐ 604 👀 21
